...
module.exports = async function startVolunteers() {
  ...
  discordClient.on('guildMemberAdd', member => {
    ...
    discordClient.channels.fetch('817219700467302461')
    .then((channel) => channel.send(`Welcome to the AURA Discord server, ${member}! To get access to the rest of the server, make sure to Verify your AURA Membership at <#816653958042746960>.`))
    .catch(console.error);
  });
